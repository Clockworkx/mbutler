    ...
    add_group: async function (reaction, user) {
        ...
        if(reaction.message.partial)
        {
            try {
                ...
                //console.log(msg.id);
                if(msg.id === '626583570550358017' || msg.id === '638265593090408449' || msg.id === '697083917592952912' )
                {
        ...
        else 
        {
            ...
            if(reaction.message.id === '626583570550358017' || reaction.message.id === '697083917592952912' || reaction.message.id === '697078905538085015') {
